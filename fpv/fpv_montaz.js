...
$('body').fadeIn(1000);
	...
	var tekst2 =  "Budowę drona należy zacząć od montażu jego ramion. Na ramionach zamontujesz silniki oraz regulatory ESC.<br><br>Do montażu silnika użyj czterech śrub M1. Przyłóż podstawę silnika tak aby przewody były położone na ramieniu, a następnie przykręć pierwszą śrubę. Gdy to zrobisz ustaw silnik tak by jego oś była w osi środkowego otworu ramienia, a nagwintowane otwory silnika były widoczne przez pozostałe trzy podłużne otwory. Teraz przykręć pozostałe śruby.<br><br>Następnie należy zająć się przymocowaniem oraz lutowaniem regulatora ESC. W pierwszej kolejności przyłóż go do ramienia w takiej odległości od silnika aby nie zasłaniał otworów. ESC musi być skierowane trzema przewodami w stronę silnika. Odmierz odpowiednią długość przewodów silnika i ESC a następnie utnij je z zachowaniem odpowiedniego zapasu.<br><br>Gdy to zrobisz możesz zająć się lutowaniem przewodów ESC z silnikiem. Pamiętaj aby w zależności od tego czy silnik jest prawo lub lewo skrętny odpowiednio ułożyć przewody tak jak na rysunku poniżej.<br><br>Po przylutowaniu ESC należy go unieruchomić za pomocą folii termokurczliwej lub opaski samozaciskowej.";
